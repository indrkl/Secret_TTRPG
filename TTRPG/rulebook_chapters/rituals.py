...
mana to contribute to it.

Rituals can be used to prepare for combat against the odds.

Some rituals can have semi permanent effects, but they often have some daily cast limit reservation cost. Meaning as
long as these effects hold, that daily limit cannot be used.

Encounter limit cannot be used for rituals! 
'''
...
examples = [
    ...
    points. Also gaining exhaustion. This ritual would need to be cast each night, discord ritual.''',
