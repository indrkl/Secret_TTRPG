...
Toughness - This also applies to your HP. But is also used to recover from poison, endure pain, and all sorts of bodily
harm.
...
When choosing a creative character trait, also attack a skill proficiency to it. You will be using that skill
proficiency for actions invoked by this trait. This choice however needs to make sense, a GM can always ask for an
explanation for how you see that it makes sense, and if it seems to not make sense, then may offer another skill
instead. Example a thief could be survival based, or lore based. When survival based, it is because of necessety, they
grew up in the streets and that is why they have all these skills, if it is lore based, then they have studied all the
locks and guard patterns, knows about human psychology perhaps to take advantage of that and so on.
